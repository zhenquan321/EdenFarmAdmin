	...
	<view class="content">
		<view class="my_head">
			<view class="my_head_pic">
				<image id="uinLogo" class="my_head_img img" src=""></image>
			</view>

			<view class="my_head_info">
				<view class="my_head_name" id='nickname'></view>
			</view>
		</view>
		...
		<view class="fui-cell-group fui-cell-click">
			...
			<view class="fui-icon-group nomargin">
					<view class="icon">
						<image src="/static/user/daifukuan"></image>
					</view>
					<view class="text">待付款</view>
			
					<view class="icon">
						<image src="/static/user/daishouhuo"></image>
					</view>
					<view class="text">待发货</view>
			
					<view class="icon">
						<image src="/static/user/daipingjia"></image>
					</view>
					<view class="text">待收货</view>
					<view class="icon">
						<image src="/static/user/yiwancheng"></image>
					</view>
		...
		<view class="goods-info">
				<view class="row-box">
					<view class="row-label">会员中心</view>
					<view class="right-text" style='color:#666'>伊甸余额：¥ </view>
				</view>
				<view class="row-box">
					<view class="row-label">地址管理</view>
...
.fui-icon-group .fui-icon-col:before {
  content: " ";
  position: absolute;
  right: -1px;
  top: 16rpx;
...
.goods-info .row-box{
    ...
    padding: 36rpx 30rpx 12rpx 30rpx;
    font-size: 28rpx;
    color: #000;
}
